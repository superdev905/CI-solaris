...
$(document).ready(function () {    
	...
	$('.act').on('click', function (e) {        
		...
		$('body').append(            
			...
			'<p>Are you sure you want to ' + text.toLowerCase() + ' this?</p>' +            
			'<div class="button-group">' +            
			'<a href="' + href + '" class="button">Yes</a> ' +            
		...
		function (isConfirm) {                
			if (isConfirm) {                    
				$.ajax({                        
					...
					dataType: "html",                        
					success: function () {                            
						$('#' + id).html('<i class="fa fa-cog"></i> Reset').closest('.transaction-row')                                
	...
	},1000);/*// Smooth animation when scrolling*/    
	...
	$('.go-ahead').on('click', function (e) {       
		...
		if ($b_name == "" || $b_email == "" || $b_address == "" || $b_country == "" || $b_city == "" || $b_postal_code == "" || $b_phone == "") {
			$("#ajaxWarning").show();
		} else {
	...
	$('.ajax-submit').on('click', function (e) {        
		...
		if (pinThe != pinEnter) {            
			sweetAlert("Oops...", "Something went wrong! That Pin doesn't match our records", "error");        
			...
			$.ajax({                
				...
				success: function () {                    
					if (choice == 'approve') {                        
						swal("Transaction Approved!", "Please continue and select your delivery address", "success");                        
						var htmlContent = '<span class="label success"><i class="fa fa-check"></i> Approved</span>';                        
						...
						function(isConfirm){                                
							if (isConfirm) {                                    
								...
								var htmlContent = '<span class="label alert"><i class="fa fa-close"></i> Declined</span>';                                    
								$('#client_reply').html(htmlContent);                                
							}                            
						});                    
					}                    
